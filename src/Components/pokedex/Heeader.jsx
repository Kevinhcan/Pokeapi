...
const Heeader = () => {
  ...
  return (
    <section className="relative">
      ...
      <i onClick={ handleClickLogout } className='bx bxs-log-out-circle absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white z-30 text-3xl hover:text-red-600 transition duration-300 cursor-pointer'></i>
      </div>
    </section>
  );
};
